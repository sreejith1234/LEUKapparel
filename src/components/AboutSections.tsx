const AboutSections = () => {
  const sections = [
    ...
    },
    {
      ...
      content: "Tack apparels custom clothing manufacturer USA helps you to build your brand today. Give us a brief of what you're looking for, and we'll make it happen with low minimums and short lead times. To ensure that your apparels manufacturer can compete with leading brands in the fashion business without sacrificing quality, our knowledgeable and experienced manufacturing teams put in a lot of effort. Tack apparels high-quality clothing manufacturer is your one-stop shop for all types of fashion apparels, from designing to production & printing.",
    },
    {
      title: "Tack Apparels Clothing Manufacturer USA: Screen Printing, Embroidery, Cut & Sew",
      content: "Tack Apparels Custom apparels manufacturer offers service for both small and large fashion brands and companies. We are a one-stop shop where you can get any type of bespoke clothing you need. We provide quality clothing manufacturer services in the USA to assist building designers in fast realizing their clothing line ambitions and converting their innovation and entrepreneurship into tangible revenues.",
    },
    {
