const AboutSections = () => {
  const sections = [
    ...
    {
      title: "Become the Most Recognized Clothing Manufacturer in the USA",
      content: "Tack apparel custom clothing manufacturer USA helps you to build your brand today. Give us a brief of what you're looking for, and we'll make it happen with low minimums and short lead times. To ensure that your apparel manufacturer can compete with leading brands in the fashion business without sacrificing quality, our knowledgeable and experienced manufacturing teams put in a lot of effort. Tack apparel high-quality clothing manufacturer is your one-stop shop for all types of fashion apparel, from designing to production & printing.",
    },
    {
      title: "Tack Apparel Clothing Manufacturer USA: Screen Printing, Embroidery, Cut & Sew",
      content: "Tack Apparel Custom apparel manufacturer offers service for both small and large fashion brands and companies. We are a one-stop shop where you can get any type of bespoke clothing you need. We provide quality clothing manufacturer services in the USA to assist building designers in fast realizing their clothing line ambitions and converting their innovation and entrepreneurship into tangible revenues.",
    },
    {
      title: "Budget Friendly Apparel Partner",
      content: "We provide enticing pricing tiers and incentives for greater orders. You'll be able to benefit from higher profits as your brand and company grow along with us. Because we have a complete garment production line and extensive knowledge of private-label clothing manufacturing. Our experts assess each element and adornment needed to provide your final product to produce chic and current custom apparel. You have total control and visibility over the entire process with our vertically integrated production process.",
    },
    {
      title: "Simplify Your Brand Building Process with our Clothing Knowledge and Experience",
      content: "We are among the good clothing manufacturers of customized products, providing a flawless user experience and unrestricted assistance all along the way. We can create practically any kind of personalized clothing because we are a reputable apparel manufacturer. You will be assisted at every step of the way by our production staff, who will also give you regular updates. Because of this, we can give you exactly what you need in the quantity you want. By doing so, you can avoid working with third parties and purchase your whole custom clothing collection.",
    },
    {
      title: "Best Custom Apparel Manufacturer with Minimum MOQ",
